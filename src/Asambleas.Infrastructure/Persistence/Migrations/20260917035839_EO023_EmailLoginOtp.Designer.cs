...
namespace Asambleas.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260917035839_EO023_EmailLoginOtp")]
    partial class EO023_EmailLoginOtp
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.Assembly", b =>
                {
                    ...
                    b.Property<string>("SealedMinutesDocumentId")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("SealedMinutesHash")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)");

                    b.Property<string>("SealedMinutesJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.AssemblyAccessLink", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("FirstRedeemedAtUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.AssemblyChatMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssemblyId", "CreatedAtUtc");

                    b.ToTable("assembly_chat_messages", (string)null);
                });
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.AssemblyParticipant", b =>
                {
                    ...
                    b.Property<string>("RoomEntryRejectReason")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)");

                    b.Property<DateTimeOffset?>("RoomEntryRequestedAtUtc")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("RoomEntryStatus")
                        .IsRequired()
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.EmailLoginChallenge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("EmailNormalized", "ExpiresAtUtc");

                    b.ToTable("email_login_challenges", (string)null);
                });
            ...
            modelBuilder.Entity("Asambleas.Domain.Entities.OwnerPasswordReset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("owner_password_resets", (string)null);
                });
